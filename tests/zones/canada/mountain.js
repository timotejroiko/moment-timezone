...
exports["Canada/Mountain"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Canada/Mountain", { offset: true, expect: "America/Edmonton" }),

	"guess:by:abbr" : helpers.makeTestGuess("Canada/Mountain", { abbr: true, expect: "America/Edmonton" }),
