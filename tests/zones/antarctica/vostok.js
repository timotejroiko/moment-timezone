...
exports["Antarctica/Vostok"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Antarctica/Vostok", { offset: true, expect: "Asia/Karachi" }),

	"guess:by:abbr" : helpers.makeTestGuess("Antarctica/Vostok", { abbr: true, expect: "Asia/Karachi" }),
