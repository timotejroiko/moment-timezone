...
exports["Antarctica/Casey"] = {
	...
	"guess:by:offset" : helpers.makeTestGuess("Antarctica/Casey", { offset: true, expect: "Asia/Manila" }),

	"guess:by:abbr" : helpers.makeTestGuess("Antarctica/Casey", { abbr: true, expect: "Asia/Manila" }),
